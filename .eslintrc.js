module.exports = {
  ...
  rules: {
    ...
    '@typescript-eslint/no-empty-interface': 'off', // Disable the no-empty-interface rule
    ...
    'keyword-spacing': 'off', // require a space after certain keywords (off by default)
    ...
    'object-curly-spacing': [0, 'never'], // require or disallow spaces inside brackets (off by default)
